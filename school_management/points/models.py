...
class Classes(models.Model):
    ...
    class_number = models.PositiveSmallIntegerField(validators=[MinValueValidator(1), MaxValueValidator(12)],
                                                    null=False)
    ...
    class_points = models.PositiveSmallIntegerField(validators=[MinValueValidator(0), MaxValueValidator(999)],
                                                    null=False)
...
class PointsLog(models.Model):
    ...
    points_log_amount = models.PositiveSmallIntegerField(validators=[MinValueValidator(1), MaxValueValidator(100)], null=False)
